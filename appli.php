...
<div id="wrapper" class="wrapper" v-cloak>
    ...
    <div class="content" v-if="affichage">
        ...
        <div id="livres" v-for="l in filtrer">
            ...
            <button v-on:click="addLivre(l.doc._id)">Ajouter à la collection</button>
        </div>
    </div>
    <div class="footer">
        Footer
...
<script>
    ...
    var livres = new Vue({
        ...
        methods: {
            addLivre : function(id){
                var docSpec = db.get(id);

                //Voir comment faire pour put dans la base de données utilisateur
                db.put({
                    _id: 'mydoc',
                    title: 'Heroes'
